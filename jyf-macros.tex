...
% \obl and \objth take 1 arg: the	subscript
\newcommand{\objth}[1]{\textsc{obj}\ensuremath{_{\footnotesize\textsc{#1}}}}
\newcommand{\obl}[1]{\textsc{obl}\ensuremath{_{\footnotesize\textsc{#1}}}}
...
\newcommand{\gap}{\rule{0.5cm}{0.01cm}}
...
\newcommand{\denotes}[1]{\ifmmode \llbracket \norm{#1}\rrbracket\else $\llbracket$\norm{#1}$\rrbracket$\fi}
\newcommand{\Land}{\land}
\newcommand{\pt}{\prd{pt}}
...
%
\newcommand{\translation}[1]{$\denotes{\norm{#1}} = $}
...
\newcommand{\lex}[1]{\textbf{\denote{#1}}}
